    ...
    <aside className="inputs-panel card">
      ...
      <div className="input-section">
        ...
        <p className="section-desc">
          Discounts when paying full price upfront (coupon, store offer, etc.)
        </p>

        <div className="field">
          <label htmlFor="cashDiscount">Cash / Upfront Discount (₹)</label>
          <input
            id="cashDiscount"
            type="number"
            min="0"
            ...
            onChange={(e) => handleChange('cashDiscount', e.target.value)}
          />
        </div>
      </div>
